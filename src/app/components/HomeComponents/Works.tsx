...
const Works = () => {
  return (
    <>
      <section className="bg-gold-50 py-16 max-container padding-container m-6 bg-gold-50">
        <div className=" mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
          ...
          {/* Right content */}
          <div className="md:w-1/2 mt-10 md:mt-0 flex justify-center md:justify-end relative overflow-hidden h-full">
            <Image
              src={phones}
              alt="Phone Preview"
              // width={300}
              // height={600}
              className="rounded-xl z-10 -mb-48"
            />
          </div>
        </div>
      </section>
